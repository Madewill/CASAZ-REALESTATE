...
const HeroBanner = () => {
  return (
    <Fade in>
    <Box 
    position='relative' minHeight={{base:'110vh', sm:"80vh"}}
    ...
    >
      <Box position='absolute' width='100%' height='100%' opacity='0.85' backgroundColor='blue.900' />

      <Box display='flex' flexDirection={{base: 'column', sm: "row" }} alignItems='center' justifyContent={{base: 'flex-start', sm: 'space-between'}}
      maxWidth='1280px' position='absolute' color='white' fontWeight='light' left='0' right='0' bottom='0' top='0' margin='0 auto' padding='2rem'>
